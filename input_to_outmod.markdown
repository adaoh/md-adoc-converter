...
![Example 2: 3 segments and not fatigue limit. Illustration of input data for fatigue capacity curve definition ](figures/um_io_fig326.svg)
...
|                               27  | Element angle \f$[\mathrm{deg}]\f$                                |
