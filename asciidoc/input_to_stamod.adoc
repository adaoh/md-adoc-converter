...
image::../figures/um_pipeinpipe_entered.png[Example: pipeinpipe modelled as `ENTERED`,456]

.Example: pipeinpipe modelled as `NOT ENTERED`
image::../figures/um_pipeinpipe_notentered.png[Example: pipeinpipe modelled as `NOT ENTERED`,608]
